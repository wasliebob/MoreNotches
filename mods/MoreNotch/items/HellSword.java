...
public class HellSword extends Item
{
private int weaponDamage;
private final EnumToolMaterial toolMaterial;

public HellSword(int ID, EnumToolMaterial material, String name)
{
...
this.weaponDamage = 10 + toolMaterial.getDamageVsEntity(); //How strong it is on enemies
setUnlocalizedName("MoreNotch:hellsword");
