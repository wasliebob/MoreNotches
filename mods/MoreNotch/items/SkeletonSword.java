...
public SkeletonSword(int ID, EnumToolMaterial material, String name)
{
...
this.weaponDamage = 6 + toolMaterial.getDamageVsEntity(); //How strong it is on enemies
setUnlocalizedName("MoreNotch:skeletonsword");
