...
public class SlenderSword extends Item
{
private int weaponDamage;
private final EnumToolMaterial toolMaterial;

public SlenderSword(int ID, EnumToolMaterial material, String name)
{
...
this.weaponDamage = 12 + toolMaterial.getDamageVsEntity(); //How strong it is on enemies
setUnlocalizedName("MoreNotch:slendersword");
