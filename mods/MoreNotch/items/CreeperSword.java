...
public class CreeperSword extends Item
{
private int weaponDamage;
private final EnumToolMaterial toolMaterial;
private int explosionRadius = 5;

public CreeperSword(int ID, EnumToolMaterial material, String name)
{
...
this.weaponDamage = 8 + toolMaterial.getDamageVsEntity(); //How strong it is on enemies
setUnlocalizedName("MoreNotch:creepersword");
...
public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4, int par5, int par6)
{

            boolean flag = par2World.getGameRules().getGameRuleBooleanValue("mobGriefing");
            par2World.createExplosion(par3EntityPlayer, par4, par5, par6, (float)this.explosionRadius, flag);
