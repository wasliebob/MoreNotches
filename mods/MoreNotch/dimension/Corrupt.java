...
public class Corrupt extends EntityMob
{
public Corrupt(World par1World) 
{
super(par1World);
this.texture = "/mods/MoreNotch/textures/mobs/corrupted.png";
this.moveSpeed = 0.5F;
...
{
return "/mods/MoreNotch/textures/mobs/corrupted.png";
}
