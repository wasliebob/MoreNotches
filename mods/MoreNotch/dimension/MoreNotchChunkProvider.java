...
public class MoreNotchChunkProvider implements IChunkProvider
{
    /** RNG. */
    private Random rand;
...
*/
    ...
    public MoreNotchChunkProvider(World par1World, long par2, boolean par4)
    {
                        ...
                        for (int x2 = 0; x2 < 4; ++x2)
                        {
                            ...
                            for (int n = 0; n < 4; ++n)
                            {
                                if ((d16 += d15) > 0.0D)
                                {
                                 ...
                                 continue;
                                    par3ArrayOfByte[index += dy] = (short)MoreNotch.cloud.blockID;
                                }
                                else if (y1 * 8 + y2 < b2)
                                {
                                 if(index + dy >= par3ArrayOfByte.length)
    ...
    public void replaceBlocksForBiome(int par1, int par2, short[] par3ArrayOfByte, BiomeGenBase[] par4ArrayOfBiomeGenBase)
    {
        ...
        for (int z = 0; z < 16; ++z)
        {
            for (int x = 0; x < 16; ++x)
            {
                ...
                int j1 = -1;
                short b1 = ((BiomeGenHeaven)biomegenbase).sTopBlock;
                short b2 = ((BiomeGenHeaven)biomegenbase).sFillerBlock;
                ...
                for (int y = 127; y >= 0; --y)
                {
                    ...
                    else
                    {
                        ...
                        else if (b3 == MoreNotch.cloud.blockID)
                        {
                            if (j1 == -1)
                            {
                                if (i1 <= 0)
                                {
                                    b1 = 0;
                                    b2 = (short)MoreNotch.cloud.blockID;
                                }
                                else if (y >= b0 - 4 && y <= b0 + 1)
                                {
                                    b1 = ((BiomeGenHeaven)biomegenbase).sTopBlock;
                                    b2 = ((BiomeGenHeaven)biomegenbase).sFillerBlock;
                                }
                            ...
                            else if (j1 > 0)
                            {
                                ...
                                if (j1 == 0 && b2 == MoreNotch.cloud.blockID)
                                {
