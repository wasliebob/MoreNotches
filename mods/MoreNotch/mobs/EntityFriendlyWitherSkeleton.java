...
public class EntityFriendlyWitherSkeleton extends EntityMob implements IRangedAttackMob
{
    private EntityAIArrowAttack aiArrowAttack = new EntityAIArrowAttack(this, 0.25F, 20, 60, 15.0F);
    private EntityAIAttackOnCollide aiAttackOnCollide = new EntityAIAttackOnCollide(this, EntityMob.class, 0.31F, false);

    public EntityFriendlyWitherSkeleton(World par1World)
    {
        super(par1World);
    ...
    public boolean attackEntityAsMob(Entity par1Entity)
    {
        ...
        {
            if (this.getSkeletonType() == 0 && par1Entity instanceof EntityLiving)
            {
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.worldObj.isRemote && this.getSkeletonType() == 0)
        {
    ...
    {
        return this.getSkeletonType() == 0 ? "/mob/skeleton_wither.png" : super.getTexture();
    }
    ...
    public void attackEntityWithRangedAttack(EntityLiving par1EntityLiving, float par2)
    {
        ...
        if (EnchantmentHelper.getEnchantmentLevel(Enchantment.flame.effectId, this.getHeldItem()) > 0 || this.getSkeletonType() == 0)
        {
