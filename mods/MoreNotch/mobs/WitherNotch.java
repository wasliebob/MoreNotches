...
public class WitherNotch extends EntityWither implements WitherDisplay, IRangedAttackMob
{
    ...
    public WitherNotch(World par1World)
    {
        super(par1World);
        this.setEntityHealth(this.getMaxHealth());
        this.texture = "/mods/MoreNotch/textures/mobs/withernotch.png";
    ...
    {
        super.entityInit();
        this.dataWatcher.addObject(21, new Integer(100));
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        this.dataWatcher.updateObject(21, Integer.valueOf(this.health));
    }
    ...
    {
    return "/mods/MoreNotch/textures/mobs/withernotch.png";
    }
    ...
    private void func_82209_a(int par1, double par2, double par4, double par6, boolean par8)
    {
        ...
        double d7 = par4 - d4;
        double d8 = par6 - d5;
        EntityNotchSkull entitywitherskull = new EntityNotchSkull(this.worldObj, this, d6, d7, d8);
    ...
    {
        this.dropItem(MoreNotch.amulet.itemID, 1);
        this.dropItem(MoreNotch.i6.itemID, 1);
        this.dropItem(MoreNotch.note.itemID, 1);
        this.dropItem(MoreNotch.book.itemID, 1);
    ...
    {
        return this.dataWatcher.getWatchableObjectInt(22 + par1);
    }

    public void func_82211_c(int par1, int par2)
    {
        this.dataWatcher.updateObject(22 + par1, Integer.valueOf(par2));
    }
