...
public class EntityNotchSkull extends EntityWitherSkull
{
    public EntityNotchSkull(World par1World)
    {
        super(par1World);
        this.setSize(0.3125F, 0.3125F);
    }

    public EntityNotchSkull(World par1World, EntityLiving par2EntityLiving, double par3, double par5, double par7)
    {
    ...
    public EntityNotchSkull(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
    {
        ...
        if (!this.worldObj.isRemote)
        {
            if (par1MovingObjectPosition.entityHit != null)
            {
                ...
                if (par1MovingObjectPosition.entityHit instanceof EntityLiving)
                {
                    ...
                    if (b0 == 0)
                    {
                        ((EntityLiving)par1MovingObjectPosition.entityHit).addPotionEffect(new PotionEffect(Potion.blindness.id, 30 * b0, 100));
                    }
                    if (b0 == 1)
                    {
                        ((EntityLiving)par1MovingObjectPosition.entityHit).addPotionEffect(new PotionEffect(Potion.blindness.id, 30 * b0, 100));
    ...
    {
    return "/mods/MoreNotch/textures/mobs/notchskull.png";
    }
