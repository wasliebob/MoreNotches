...
public class SquidNotch extends EntitySquid
{
    ...
    public SquidNotch(World par1World)
    {
        super(par1World);
        this.texture = "/mods/MoreNotch/textures/mobs/squidnotch.png";
    ...
    {
    return "/mods/MoreNotch/textures/mobs/squidnotch.png";
    }
