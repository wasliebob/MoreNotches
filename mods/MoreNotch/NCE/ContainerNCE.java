...
public class ContainerNCE extends Container
{
...
private int posY;
private int posZ;
public ContainerNCE(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5)
{
...
{
         ItemStack stack = CraftingNCE.getInstance().findMatchingRecipe(this.craftMatrix, this.worldObj);
...
{
         return this.worldObj.getBlockId(this.posX, this.posY, this.posZ) != MoreNotch.amulet.itemID ? false : player.getDistanceSq((double)this.posX + 0.5D, (double)this.posY + 0.5D, (double)this.posZ + 0.5D) <= 64.0D;
}
}