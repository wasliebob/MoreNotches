...
public class CraftingNCE
{
/** The static instance of this class */
private static final CraftingNCE instance = new CraftingNCE();
...
/**
         ...
         */
public static final CraftingNCE getInstance()
{
         return instance;
}
private CraftingNCE()
{
         Collections.sort(this.recipes, new RecipeSorterNCE(this));
         System.out.println(this.recipes.size() + " NCE Recipe");
}
/**
