...
public class HellChunkProvider implements IChunkProvider
{
    ...
    public HellChunkProvider(World par1World, long par2)
    {
    ...
    public void replaceBlocksForBiome(int par1, int par2, byte[] par3ArrayOfByte)
    {
        ...
        for (int k = 0; k < 16; ++k)
        {
            for (int l = 0; l < 16; ++l)
            {
                ...
                int j1 = -1;
                byte b1 = (byte)Block.netherBrick.blockID;
                byte b2 = (byte)Block.netherBrick.blockID;
                ...
                for (int k1 = 127; k1 >= 0; --k1)
                {
                    ...
                    if (k1 < 127 - this.hellRNG.nextInt(5) && k1 > 0 + this.hellRNG.nextInt(5))
                    {
                        ...
                        else if (b3 == Block.netherBrick.blockID)
                        {
                            if (j1 == -1)
                            {
                                if (i1 <= 0)
                                {
                                    b1 = 0;
                                    b2 = (byte)Block.netherBrick.blockID;
                                }
                                else if (k1 >= b0 - 4 && k1 <= b0 + 1)
                                {
                                    b1 = (byte)Block.netherBrick.blockID;
                                    b2 = (byte)Block.netherBrick.blockID;
