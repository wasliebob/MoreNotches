...
public class HellPortal extends BlockPortal {

        public HellPortal(int id) {
                super(id);
                
             // Constructor Configuration
                setUnlocalizedName("MoreNotch:portal2");
                setResistance(5.0F);
                setBlockUnbreakable();
        }
        ...
        {
                 blockIcon = iconRegister.registerIcon("MoreNotch:portal2");
        }
        ...
        if (par5Entity.dimension != 19)
        {
        thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 19, new TeleportHell(thePlayer.mcServer.worldServerForDimension(19)));
        }
        else
        {
        thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TeleportHell(thePlayer.mcServer.worldServerForDimension(0)));
        }
        }
        }
        }
