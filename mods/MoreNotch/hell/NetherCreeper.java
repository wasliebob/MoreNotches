...
public class NetherCreeper extends EntityCreeper
{
    /**
    ...
    public NetherCreeper(World i)
    {
        super(i);
        this.texture = "/mods/MoreNotches/textures/mobs/hellcreeper.png";
            ...
            if (this.timeSinceIgnited >= this.fuseTime)
            {
                ...
                if (!this.worldObj.isRemote)
                {
                    ...
                    if (this.getPowered())
                    {
                		...
                		NetherCreeper ewp = new NetherCreeper(worldObj);
                		NetherCreeper ewp2 = new NetherCreeper(worldObj);
    ...
    {
    return "/mods/MoreNotch/textures/mobs/hellcreeper.png";
    }
